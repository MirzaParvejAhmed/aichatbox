...
//                   {msg.sender._id === "ai" ? (
//                      <Markdown>{JSON.parse(msg.message).text}</Markdown>
...
//       <section className="right flex flex-grow h-full bg-red-100">
...
//                     className={`open-file cursor-pointer p-2 w-fit px-4 items-center flex gap-2 bg-cyan-200`}
//                   >
//                     <p className="font-semibold text-lg">{file}</p>
//                   </button>
//                 ))}
...
//                       })
//                     );
//                     const runnProcess = await webContainer.spawn("npm", [
//                       "start",
//                     ]);
//                     runnProcess.output.pipeTo(
//                       new WritableStream({
//                         write(chunk) {
//                           console.log(chunk);
//                         },
...
//                       }}
//                       dangerouslySetInnerHTML={{__html:hljs.highlight('javascript',
  ...
  {Object.keys(fileTree || {}).map((file, index) => (
    <button
      ...
      onClick={() => {
        ...
        console.log("Current File:", file); // Log the current file
        console.log("File Tree:", fileTree); // Log the file tree
      }}
